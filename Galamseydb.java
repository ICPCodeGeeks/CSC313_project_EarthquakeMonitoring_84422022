...
public String maxAvgObserv(){
        try{
            ...
            while(rs.next()){
                ...
                //System.out.println(galam_observData);
                GId=getIDGalam_Observ(observData);
                int count=0;
                double avg;
                for(int i =0; i<GId.size();i++){
                    String text =getGalamsey(GId.get(i));
            ...
            String text =getObservatory(index);
            String[] gWords= text.split(":");
            return gWords[1];
    ...
    /**
     *This method gets all the record from the galamsey_observatory table
     ...
     * @throws SQLException
     */
    public void addObservatory(Galamsey gam) throws SQLException{
    ...
    /**
     *This method inserts a single record from the galamsey_observatory table
     * @param GID
     * @param OID
     * @throws SQLException
     */
